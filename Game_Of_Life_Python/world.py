...
class World:
    def __init__(self, screen_height = 600, screen_width = 600):
        ...
        self.option_rectangle_offset = (self.screen_width - 3 * self.option_rectangle_width) / 4
        ...
        self.options_font_left = [self.option_rectangle_left[i] + self.option_rectangle_width * 0.11 for i in range(3)]
